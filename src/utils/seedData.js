    ...
    state: {
      ...
      equipmentFolders: {
        101: {
          ...
          repairs: [
            { id: 'rep-101-1', date: '2026-01-15', type: 'Weld Overlay', method: 'SMAW', technician: 'R. Ahmad', wps: 'WPS-BW-042', location: 'Bottom Drum Shell — 180°', scope: 'Weld overlay build-up on bottom drum shell at 180° location. 3-pass overlay using E7018 electrodes.', ndt: 'UT', ndtResult: 'Acceptable', thicknessAfter: 24.8, signoff: 'A. Rahman', remarks: 'Post-repair UT confirms full fusion.' },
            { id: 'rep-101-2', date: '2025-04-20', type: 'Tube Replacement', method: 'GTAW', technician: 'R. Ahmad', wps: 'WPS-BW-015', location: 'Top Drum — Tube Bank 3', scope: 'Replaced 3 water tubes due to wall thinning.', ndt: 'RT', ndtResult: 'Acceptable', thicknessAfter: null, signoff: 'A. Rahman', remarks: 'Hydrotest passed.' }
          ],
          alterations: [],
          thicknessHistory: [
        ...
        102: {
          ...
          repairs: [
            { id: 'rep-102-1', date: '2025-08-10', type: 'Patch Plate', method: 'GTAW + SMAW', technician: 'K. Lee', wps: 'WPS-PV-018', location: 'Shell — 180°', scope: 'Installation of 6mm SS316 patch plate over thinned area.', ndt: 'RT', ndtResult: 'Acceptable', thicknessAfter: 29.2, signoff: 'M. Johnson', remarks: 'RT confirmed no defects.' }
          ],
          alterations: [],
          thicknessHistory: [
